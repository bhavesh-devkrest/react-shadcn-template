...
export function DateTimePicker({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      ...
      <PopoverContent
        className="w-auto p-2 min-h-[370px] bg-transparent shadow-none border-none flex"
        align="center"
        updatePositionStrategy="optimized"
        sticky="partial"
      >
        <div className="bg-card shadow-sm p-4 rounded-md border">
            ...
            {years.map((year) => (
              ...
              >
                <Button
                  ...
                  variant={getYear(value) === year.value ? undefined : "ghost"}
          ...
          <div className="grid grid-cols-3 gap-4">
            {months.map((month) => (
              <Button
                ...
                variant={getMonth(value) === month.value ? undefined : "ghost"}
                className="rounded-full"
                onClick={() =>
